...
export default function PartnerApplyPage() {
  ...
  if (done) {
    return (
      <div className="mx-auto max-w-lg space-y-4 py-12 text-center">
        ...
        <p className="text-[#bdbdbd]">We will review your application and notify you once approved.</p>
        <Button asChild><Link href="/partner">Go to portal</Link></Button>
      </div>
    );
  }
  ...
  return (
    <div className="mx-auto max-w-xl space-y-6">
      <div>
        <h2 className="text-2xl font-bold text-white">Become a Connect partner</h2>
        <p className="text-[#8c8c8c]">Apply to receive qualified financial help enquiries</p>
      </div>
      ...
      <Card>
        ...
        <CardContent>
          <form onSubmit={submit} className="space-y-4">
            ...
            <div>
              <Label>NCR / FSP registration number</Label>
