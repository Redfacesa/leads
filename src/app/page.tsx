      ...
      <header className="border-b border-[#262626] bg-[#111]">
        <div className="mx-auto flex max-w-5xl items-center justify-between px-4 py-4 sm:px-6">
          ...
          <nav className="flex items-center gap-4 text-sm">
            ...
            <Link href="/login?next=/partner/apply" className="text-[#bdbdbd] hover:text-white">Partners</Link>
            <Link href="/signup" className="text-[#bdbdbd] hover:text-white">Register</Link>
